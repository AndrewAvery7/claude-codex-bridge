...
- **[@ayobamiseun](https://github.com/ayobamiseun)** — [#469](https://github.com/openai/codex-plugin-cc/pull/469) is the upstream patch worth watching for this lookup bug, covering both the path-prefix mismatch and the content-hash race. Open and still unreviewed as of 2026-08-22 — an independent Windows reproduction was posted on it 2026-08-12, and a separate attempt at the same fix, [#551](https://github.com/openai/codex-plugin-cc/pull/551), was closed unmerged on 2026-07-26; until one lands, this kit sidesteps both failure modes by verifying against Codex's own state instead.
